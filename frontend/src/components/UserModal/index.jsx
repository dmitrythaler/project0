...
export default ({ visible, onClose, onSave, user, adminMode }) => {
  ...
  const lastLogin = currUser.lastLogin?.replace('T', ' ').slice(0, -5) || 'never'
      ...
      <form>
        ...
        <div className="grid gap-4 lg:grid-cols-4 mb-4">
          ...
          <div className="lg:col-span-2">
            ...
            <input type="password" id="password" name="password" onChange={onChange} value={currUser.password}
        ...
        <div className="grid gap-4 lg:grid-cols-12 mb-4">
          ...
          <div className="lg:col-span-6" >
            ...
            <input type="text" id="lastLogin" name="lastLogin" value={lastLogin}
